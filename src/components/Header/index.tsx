    ...
    <div className='bg-blackLine h-full w-full'>
      <div className='flex justify-between p-6'>
        ...
        <div className='bg-white flex items-center justify-around rounded h-[30px] w-[140px] hover:bg-red-500 transition-colors'>
          <img alt='Imagem meta mask.' className='w-4 h-4' src={mask} />

          <button className='text-sm text-black'>Conectar Carteira</button>
        </div>
      </div>
      ...
      <div className='flex items-baseline justify-between p-6 w-full'>
        <div>
          <p className='text-zinc-200 text-sm whitespace-normal w-[50%] pb-6'>
            Mercado digital para colecionáveis em criptos e tokens não fungível (NFT). Compre, venda
            e descubra ativos digitais exclusivos para você.
          </p>

          <div className='flex items-baseline text-zinc-200'>
            <img src={avatars} alt='imagem dos avatars.' />
            <strong className='p-2'>+10</strong>
          ...
          <div className='flex justify-between pt-6 w-full'>
            ...
            <img alt='imagem do badge.' className='h-[100px] w-[100px]' src={badge} />
          </div>
        </div>
      </div>

      <img className='w-full p-6' alt='imagem astronaut avatars.' src={astronautAvatars} />
    </div>
  );
};